...
exports.exampleWithCustomConfig = exampleWithCustomConfig;
exports.exampleManualScale = exampleManualScale;
exports.exampleMultiPage = exampleMultiPage;
exports.exampleExportMarkers = exampleExportMarkers;
...
async function exampleBasicDetection() {
    ...
    const pdfBuffer = fs_1.default.readFileSync('./sample-floorplan.pdf');
    const result = await (0, wallDetector_1.detectWallsInPDF)(pdfBuffer);
...
async function exampleManualScale() {
    ...
    const pdfBuffer = fs_1.default.readFileSync('./sample-floorplan.pdf');
    let result = await (0, wallDetector_1.detectWallsInPDF)(pdfBuffer);
...
async function exampleMultiPage() {
    ...
    const pdfBuffer = fs_1.default.readFileSync('./multi-page-floorplan.pdf');
    const result = await (0, wallDetector_1.detectWallsInPDF)(pdfBuffer);
...
async function exampleExportMarkers() {
    ...
    fs_1.default.writeFileSync('markers.csv', csvContent);
