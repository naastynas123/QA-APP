...
class GeometryUtils {
     ...
     */
    static interpolatePointAtDistance(polyline, distanceMetres, metresPerUnit) {
     ...
     */
    static areSegmentsCollinear(seg1, seg2, angleTolerance = 10) {
     ...
     */
    static pointsEqual(p1, p2, threshold = 1) {
     ...
     */
    static approximateArcLength(seg, steps = 10) {
     ...
     */
    static pointNearSegment(point, seg, threshold = 5) {
