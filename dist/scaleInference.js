...
class ScaleInference {
     ...
     */
    inferScale(dimensionLines, pageText) {
     ...
     */
    detectScaleAnnotation(pageText) {
     ...
     */
    inferFromDimensionLines(dimensionLines) {
    ...
    assessDimensionLineConfidence(dimLine) {
        let confidence = 0.5;
     ...
     */
    static createManualScale(metresPerUnit) {
        return {
            metresPerUnit,
            strategy: 'annotation',
            confidence: 'high',
...
exports.ScaleInference = ScaleInference;
//# sourceMappingURL=scaleInference.js.map